package com.company.onboarding3008.test_support;

import com.company.onboarding3008.Onboarding3008Application;
 ...
 */
@SpringBootTest
@UiTest(authenticatedUser = "admin", mainScreenId = "MainScreen", screenBasePackages = "com.company.onboarding3008.screen")
@ContextConfiguration(classes = {Onboarding3008Application.class, UiTestAssistConfiguration.class})
